...
class Four_armed_bandit_3(Competitor):
	...
	def p(self, prices_historical, demand_historical, parameterdump, t):#
		...
		if t == 0:
			...
			if t>2:
				...
				index=random.randrange(len(values_1)) #choose a random price
			#print(values_1,', ',index)
			...
			#counts
			#counts_1[index]=counts_1[index]+1 #the number of times this price is chosen increases by 1
			
			
			
			if not fix_arm:
				demand_model_to_use=index+1
				index_last_period_1=index
